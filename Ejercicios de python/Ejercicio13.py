print("Hacer un algoritmo que calcule la superficie y el volumen de un prisma rectangular ortogonal, pidiendo al usuario los datos que son necesarios para calcularlos")
